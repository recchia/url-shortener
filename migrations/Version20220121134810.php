 ...
 */
final class Version20220121134810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE short_url (id INT NOT NULL, title VARCHAR(255) NOT NULL, long_url VARCHAR(255) NOT NULL, short_url VARCHAR(9) NOT NULL, hits INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
